...
config. BgColor			= '#666666'	// Background colour (HTML colour value, in quotes)
...
config. TitleFontColor	= '#FF0000'	// Color of title text - if '', BgColor (of tooltip body) will be used
